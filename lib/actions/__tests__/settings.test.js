...
describe('Settings Actions', () => {
  ...
  describe('getSiteSettings', () => {
    ...
    it('should provide byKey for retrieving values', async () => {
      const mockSettings = [
      ...
      // Test byKey access (replaces settings.get())
      expect(result.settings.byKey['test_key'].value_en).toBe('en_value')
      expect(result.settings.byKey['test_key'].value_fa).toBe('fa_value')
      expect(result.settings.byKey['nonexistent']).toBeUndefined()
    })
  })
