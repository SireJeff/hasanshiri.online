 ...
 * Provides functions for translating text and HTML content using Google Cloud Translation API v3
 */

const GOOGLE_TRANSLATE_API_URL = 'https://translation.googleapis.com/v3/projects/${PROJECT_ID}:translateText'

/**
 * Translate plain text using Google Cloud Translation API v3
